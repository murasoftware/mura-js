...
import { faChevronRight, faChevronLeft, faBolt, faSearch } from '@fortawesome/free-solid-svg-icons';
...
import { SearchForm as SearchForm$1 } from '@murasoftware/next-modules-bs4';
...
var MatrixSelector = function MatrixSelector(props) {
  ...
  var _useState3 = useState(_selfIdStart),
      selfIdStart = _useState3[0];

  var _useState4 = useState(_selfIdMiddle),
      selfIdMiddle = _useState4[0];

  var _useState5 = useState(_selfIdEnd),
    ...
    switch (displayType) {
      case "widget":
        return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Alert, {
          ...
          className: "mb-0"
        }, "Experience Selector")), /*#__PURE__*/React.createElement("div", {
          ...
          icon: faBolt
        }), " Optimize Your Experience"), /*#__PURE__*/React.createElement("div", {
      ...
      case "eyebrow":
        ...
        }, /*#__PURE__*/React.createElement("h4", null, /*#__PURE__*/React.createElement(FontAwesomeIcon, {
          icon: faBolt
...
var MatrixForm = function MatrixForm(props) {
  return /*#__PURE__*/React.createElement(React.Fragment, null, props.updateSuccess && props.showingAlert && /*#__PURE__*/React.createElement("div", {
...
var Render = function Render(_ref) {
  ...
  })), props.props.displaysearch && /*#__PURE__*/React.createElement(SearchForm$1, null))));
};
...
function ResourceHub(props) {
  ...
  var _useState7 = useState(_hasMXP),
      hasMXP = _useState7[0],
      setHasMXP = _useState7[1];

  var _useState8 = useState(objectparams.showtextsearch),
  ...
  var _useState10 = useState(new Date().toString()),
...
var GatedAsset = function GatedAsset(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, editMode ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    className: !gateIsOpen ? 'btn btn-primary' : 'btn',
    onClick: function onClick() {
      setGateIsOpen(false);
    }
  }, "Gate"), /*#__PURE__*/React.createElement("button", {
    className: gateIsOpen ? 'btn btn-primary' : 'btn',
    onClick: function onClick() {
      setGateIsOpen(true);
    }
  }, "Asset")) : null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mura-gate",
    style: {
      display: !gateIsOpen ? 'block' : 'none'
    }
  }, /*#__PURE__*/React.createElement(Decorator, _extends({}, gateparams, {
    content: props.content,
    Mura: props.Mura
  }))), /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Decorator, _extends({}, assetparams, {
    content: props.content,
    Mura: props.Mura
  })))));
};
