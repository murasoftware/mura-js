...
var MatrixSelector = function MatrixSelector(props) {
  ...
  var _useState = React.useState(_personas),
      personas = _useState[0],
      setPersonas = _useState[1];

  var _useState2 = React.useState(_stages),
      stages = _useState2[0],
...
var MatrixForm = function MatrixForm(props) {
  ...
  }, props.personas && props.personas.length > 1 && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Form.Label, {
    className: "mr-2"
  ...
  }, !props.currentPersonaId && /*#__PURE__*/React__default.createElement("option", {
    value: "",
    key: "--"
  ...
  }))), props.stages && props.stages.length > 1 && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Form.Label, {
    className: "mr-2"
  ...
  }, !props.currentStageId && /*#__PURE__*/React__default.createElement("option", {
    value: "",
    key: "--"
  ...
  }))), props.personas && props.stages && /*#__PURE__*/React__default.createElement("p", null, props.selfIdEnd), !props.isClearing && props.selHasChanged && props.curSelPersona && props.curSelStage && /*#__PURE__*/React__default.createElement(Button, {
    className: "ml-2",
    size: "sm",
    type: "button",
    onClick: props.handlePreview
  }, props.isPreviewing ? 'Preview...' : 'Preview'), !props.isPreviewing && !props.isClearing && props.mode != 'preview only' && !props.selHasChanged && props.isPreview && /*#__PURE__*/React__default.createElement(Button, {
    className: "ml-2",
    size: "sm",
    type: "submit"
  }, props.isSaving ? 'Saving...' : 'Save'), !props.isSaving && !props.isPreviewing && (props.currentPersonaId || props.currentStageId) && /*#__PURE__*/React__default.createElement(Button, {
    className: "ml-2",
    size: "sm",
    type: "button",
...
exports.getMuraClassicDynamicProps = getDynamicProps$6;
