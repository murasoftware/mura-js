  ...
  try {
    var _temp17 = function _temp17() {
      function _temp13() {
        ...
        return Promise.resolve(getRegionProps(content, queryParams, renderMode, Mura)).then(function (moduleStyleData) {
          function _temp11() {
            function _temp9() {
            ...
            var _temp8 = function () {
              if (typeof onAfter == 'function') {
                var _temp16 = _catch(function () {
                  return Promise.resolve(onAfter(props, Mura)).then(function () {});
                }, function (e) {
      ...
      var _temp12 = _catch(function () {
        return Promise.resolve(renderContent(context, renderMode, params, Mura)).then(function (muraObject) {
    ...
    if (Mura.renderMode === 'static' && Mura.isInNode() && process && process.env && process.env.MURA_SSR_BASICTOKEN) {
    ...
    var _temp18 = function () {
      if (typeof onBefore == 'function') {
        var _temp19 = _catch(function () {
          return Promise.resolve(onBefore(Mura)).then(function () {});
        }, function (e) {
